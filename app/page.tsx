                        ...
                        {selectedImage && (
                            <div className="relative mt-2">
                                <button
                                    ...
                                    className="absolute -top-2 -right-2 bg-[#111827] rounded-full p-1 sm:p-1.5
                                ...
                                <div className="flex items-start gap-2 animate-slide-up overflow-hidden rounded-lg p-2 sm:p-3">
